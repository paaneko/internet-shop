...
<div class="flex flex-grow justify-between">
    <div class="w-[35%] space-y-8 p-5 bg-gray-100 rounded-md">
        ...
        <div class="my-8 w-full bg-gray-200 h-[2px]"></div>
        <div class="flex justify-between">
            <div class="text-xl text-gray-400 font-medium">Subtotal</div>
            <div class="text-xl font-medium">${{$order->amount_subtotal}}</div>
        </div>
        <div class="flex justify-between">
            <div class="text-xl text-gray-400 font-medium">Discount</div>
    ...
    <div class="w-[60%]">
        <div class="mb-10 space-y-7 p-5 bg-gray-100 rounded-md">
            ...
            <div class="grid grid-cols-3 gap-4 text-gray-500">
                ...
                <div class="flex flex-col">
                    ...
                    <span
                        class="text-xl font-medium text-black">{{$order->created_at->format('M j, Y g:i A')}}</span>
                </div>
            </div>
        </div>
        <div class="space-y-2">
